            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="position" readonly value="{!! $user->position !!}">
                        </div>

                        <div class="form-group">
                            <label for="province">@lang('Province')</label>
                            <input type="text" class="form-control" name="province" readonly value="{!! $user->province !!}">
                        </div>
