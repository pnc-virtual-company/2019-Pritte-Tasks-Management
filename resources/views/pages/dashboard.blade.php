        ...
        <div class="card shadow">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#myTask" role="tab"
                            aria-controls="myTask" aria-selected="true">My Tasks</a>
                    </li>
                </ul>
            </div>
            <!-- Card Body -->
                ...
                <div class="row mt-4">
                    <div class="col-2">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            ...
                            <a class="nav-link active" id="v-pills-late-tab" data-toggle="pill" href="#v-pills-late"
                                role="tab" aria-controls="v-pills-home" aria-selected="true">Late Tasks</a>
                            <a class="nav-link" id="v-pills-week-tab" data-toggle="pill" href="#v-pills-week" role="tab"
                                aria-controls="v-pills-week" aria-selected="false">Due this week</a>
                            <a class="nav-link" id="v-pills-month-tab" data-toggle="pill" href="#v-pills-month"
                                role="tab" aria-controls="v-pills-month" aria-selected="false">Due this month</a>
                    ...
                    <div class="col-10">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-late" role="tabpanel"
