        ...
        <div class="col-xl-12 col-lg-12">                            
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#collective" role="tab" aria-controls="collective" aria-selected="true">Tasks Assigned to me</a>
                  <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#collective" role="tab" aria-controls="collective" aria-selected="false">Tasks Assigned to Other</a>
                </div>
            </nav>
                                    ...
                                    <div class="modal-body">
                                        <form action="#" method="POST">
                                           ...
                                           <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">   
                                                        <input type="text" id="datepicker"placeholder="26/04/2019 8:00">
                                                    </div>
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="POST">
                                                ...
                                                <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Due date</label>
                                                        <div class="col-sm-9">   
                                                            <input type="text" id="editDatepicker"placeholder="26/04/2019 8:00">
                                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="#" method="POST">
                                                        ...
                                                        <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Due date</label>
                                                                <div class="col-sm-9">   
                                                                    <input type="text" id="editDatepicker"placeholder="22/05/2019 8:00">
                                                                </div>
